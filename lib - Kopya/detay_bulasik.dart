...
class DeviceDetailBulasik extends StatelessWidget {
  final String power;
  final String energy;
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Bulaşık Makinesi Detay'),
          bottom: const TabBar(
            tabs: [
        ...
        body: TabBarView(
          children: [
            _EnergyUsageTabBulasik(
              hourlyData: hourlyData,
              dailyData: dailyData,
              yearlyData: yearlyData,
              yearlyLabels: yearlyLabels,
            ),
            _PowerUsageTabBulasik(
...
// --------- Enerji Sekmesi ---------
class _EnergyUsageTabBulasik extends StatelessWidget {
  final List<double> hourlyData;
  final List<double> dailyData;
  final List<double> yearlyData;
  final List<String> yearlyLabels;
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            _DailyChartBulasik(data: todayHourly),
            _MonthlyChartBulasik(data: thisMonthDaily),
            _YearlyChartBulasik(
              data: yearlyData,
              labels: yearlyLabels,
            ),
...
class _DailyChartBulasik extends StatefulWidget {
  final List<double> data;
  const _DailyChartBulasik({required this.data});
  @override
  State<_DailyChartBulasik> createState() => _DailyChartBulasikState();
}

class _DailyChartBulasikState extends State<_DailyChartBulasik> {
  int? touched;
...
class _MonthlyChartBulasik extends StatefulWidget {
  final List<double> data;
  final String? aiAdvice;

  const _MonthlyChartBulasik({
    required this.data,
    this.aiAdvice,
  });

  @override
  State<_MonthlyChartBulasik> createState() => _MonthlyChartBulasikState();
}

class _MonthlyChartBulasikState extends State<_MonthlyChartBulasik> {
  int? touched;
        ...
        Container(
          ...
          child: Row(
            ...
            children: const [
              ...
              Expanded(
                child: Text(
                  "Puant saatlerde bulaşık makinesi kullanımı yüksek. Daha uygun saatlerde çalıştırmayı deneyin.",
...
class _YearlyChartBulasik extends StatefulWidget {
  final List<double> data;
  final List<String> labels;

  const _YearlyChartBulasik({
    Key? key,
    required this.data,
  ...
  @override
  State<_YearlyChartBulasik> createState() => _YearlyChartBulasikState();
}

class _YearlyChartBulasikState extends State<_YearlyChartBulasik> {
  int? touchedIndex;
...
// --------- Güç Sekmesi ---------
class _PowerUsageTabBulasik extends StatelessWidget {
  final List<double> powerDaily;
  final List<double> powerWeekly;
  final List<String> powerWeeklyLabels;

  const _PowerUsageTabBulasik({
    required this.powerDaily,
    required this.powerWeekly,
    required this.powerWeeklyLabels,
  });
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            PowerChart24SaatBulasik(data: powerDaily),
            _PowerChart7GunBulasik(data: powerWeekly, labels: powerWeeklyLabels),
          ],
        ),
      ),
    );
...
class PowerChart24SaatBulasik extends StatelessWidget {
  final List<double> data; // 288 veri

  const PowerChart24SaatBulasik({super.key, required this.data});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        const Text('Bulaşık: Son 24 Saat Güç Grafiği',
...
class _PowerChart7GunBulasik extends StatelessWidget {
  final List<double> data;
  final List<String> labels;
  const _PowerChart7GunBulasik({
    required this.data,
    required this.labels,
  });
